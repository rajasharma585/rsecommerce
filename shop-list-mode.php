...
<!-- Mirrored from d-themes.com/html/riode/shop-list-mode.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Nov 2024 08:31:32 GMT -->
						...
						<div class="col-lg-9 main-content">
							<nav class="toolbox sticky-toolbox sticky-content fix-top">
								<div class="toolbox-left">
									<a href="#"
										class="toolbox-item left-sidebar-toggle btn btn-outline btn-primary btn-icon-right d-lg-none">Filter<i
								...
								<div class="toolbox-right">
									...
									<div class="toolbox-item toolbox-layout">
										<a href="shop-list-mode.php" class="d-icon-mode-list btn-layout active"></a>
										<a href="shop.php" class="d-icon-mode-grid btn-layout"></a>
									</div>
								</div>
							</nav>
							<div class="product-lists product-wrapper">
								<div class="product product-list">
									...
									<div class="product-details">
										<div class="product-cat">
											<a href="shop-list-mode.php">Clothing</a>
										</div>
								...
								<div class="product product-list">
									...
									<div class="product-details">
										<div class="product-cat">
											<a href="shop-list-mode.php">Bags & Backpacks</a>
										</div>
										<h3 class="product-name">
								...
								<div class="product product-list">
									...
									<div class="product-details">
										<div class="product-cat">
											<a href="shop-list-mode.php">men</a>
										</div>
										<h3 class="product-name">
											<a href="product.php">Man's Blue Student Satchel</a>
										</h3>
										<div class="product-price">
										...
										<div class="ratings-container">
											...
											<a href="product.php" class="rating-reviews">( 28 reviews )</a>
										</div>
										<p class="product-short-desc">
											Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
											tempor
								...
								<div class="product product-list">
									...
									<div class="product-details">
										<div class="product-cat">
											<a href="shop-list-mode.php">Watches</a>
										</div>
										<h3 class="product-name">
											<a href="product.php">Man's Black Wrist Watch</a>
										</h3>
										<div class="product-price">
										...
										<div class="ratings-container">
											...
											<a href="product.php" class="rating-reviews">( 1 6 reviews )</a>
										</div>
										<p class="product-short-desc">
											Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
											tempor
